...
//skull achiev
	...
	new G.Res({
		name:'fruit',
		desc:'[fruit,Fruits], whether gathered from berry bushes or fruit trees, are both sweet-tasting and good for you. Also they have a weird glow.',
		icon:[4,7],
		turnToByContext:{'eating':{'health':9500,'happiness':920},'decay':{'bread':1}},
		partOf:'food',
		category:'food',
	});
	let modes4=false
